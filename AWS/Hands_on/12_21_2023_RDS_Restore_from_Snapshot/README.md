...
```bash
mysql -h adem-root-07.cziwe0giy0mr.us-east-1.rds.amazonaws.com -u admin -pPl123456789
```
...
```bash
mysql -h adem-zombi-snap-manuel.cziwe0giy0mr.us-east-1.rds.amazonaws.com -u admin -pPl123456789
```
